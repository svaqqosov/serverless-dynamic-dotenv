# serverless-dynamic-dotenv[![npm version](https://img.shields.io/npm/v/serverless-dynamic-dotenv.svg?style=flat)](https://www.npmjs.com/package/serverless-dynamic-dotenv)
